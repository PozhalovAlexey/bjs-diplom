class MoneyManager {
  constructor() {
    ...
    this.addMoneyForm
      ...
      .addEventListener("click", this.addMoneyAction.bind(this));
    this.conversionMoneyForm
      .querySelector(".button")
      .addEventListener("click", this.conversionMoneyAction.bind(this));
    this.sendMoneyForm
      .querySelector(".button")
      .addEventListener("click", this.sendMoneyAction.bind(this));
  ...
  addMoneyAction() {
    const amount = this.addMoneyForm.querySelector(
      '[placeholder="Сумма"]'
    ).value;
  ...
  conversionMoneyAction() {
    const fromAmount = this.conversionMoneyForm.querySelector(
      '[placeholder="Сумма"]'
    ).value;
    const fromCurrency =
      this.conversionMoneyForm.getElementsByTagName("select")[0].value;
    const targetCurrency =
      this.conversionMoneyForm.getElementsByTagName("select")[1].value;
  ...
  sendMoneyAction() {
    const amount = this.sendMoneyForm.querySelector(
      '[placeholder="Сумма"]'
    ).value;
