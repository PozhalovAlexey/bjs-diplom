class ProfileWidget {
  static showProfile(data) {
    ...
    profileMoney.querySelector("[data-user-wallet-rub]").innerText =
      data.balance.RUB.toPrecision(5);
    profileMoney.querySelector("[data-user-wallet-eur]").innerText =
      data.balance.EUR.toPrecision(5);
    profileMoney.querySelector("[data-user-wallet-usd]").innerText =
      data.balance.USD.toPrecision(5);
    profileMoney.querySelector("[data-user-wallet-ntc]").innerText =
      data.balance.NTC.toPrecision(5);
  }
}
